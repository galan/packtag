 ...
 * Last modified: $Date: 2007/11/12 22:52:19 $
 * Revision:      $Revision: 1.3 $
 * 
 * $Log: IBloomCssPackStrategy.java,v $
 * Revision 1.3  2007/11/12 22:52:19  danielgalan
 * origin website to comment added
 *
...
/**
 * Strategy to compress CSS files.<br/>
 * See <a href="http://www.ibloomstudios.com/articles/php_css_compressor/">here</a> for more information.
 * 
 * @author Daniel Galán y Martins
 * @version $Revision: 1.3 $
 */
public class IBloomCssPackStrategy extends AbstractPackStrategy {
